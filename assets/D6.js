...
function concatenaStringhe(s1, s2) {
  ...
  const primi2Caratteri = s1.slice(0, 2);

  const ultimi3Caratteri = s2.slice(-3);

  const risultato = primi2Caratteri + ultimi3Caratteri;
...
const arrayCasuale = elementiCasuali();
...
const valoriPari = trovaValoriPari(arrayDiNumeri);
...
const numeriVari = [3,6,9]
const risultNumeriVari = sommaArray(numeriVari)
console.log(risultNumeriVari)
